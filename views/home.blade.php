<div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="feature">
                <div class="text-primary mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" class="w-12 h-12">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                    </svg>
                </div>
                <h3 class="feature-title">High-Performance Hardware</h3>
            ...
            <div class="feature">
                <div class="text-primary mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" class="w-12 h-12">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                </div>
    ...
    <div class="mb-16">
        ...
        <div class="max-w-4xl mx-auto space-y-4" x-data="{selected:null}">
            <div class="faq-item">
                <h3 @click="selected !== 1 ? selected = 1 : selected = null" class="faq-question">
                ...
                <div x-show="selected === 1" x-transition class="faq-answer">
            ...
            <div class="faq-item">
                <h3 @click="selected !== 2 ? selected = 2 : selected = null" class="faq-question">
                ...
                <div x-show="selected === 2" x-transition class="faq-answer">
            ...
            <div class="faq-item">
                <h3 @click="selected !== 3 ? selected = 3 : selected = null" class="faq-question">
                ...
                <div x-show="selected === 3" x-transition class="faq-answer">
